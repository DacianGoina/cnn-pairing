...
![Fig. 1: Cantor Pairing function](readme-imgs/pairing-function.png) **Fig. 1: Cantor Pairing function**
...
![Fig. 2: Data transformation schema](readme-imgs/data-transformation-schema-11.png) **Fig. 2: Data transformation schema**
...
![Fig. 3: Proposed method - transformation result](readme-imgs/original-resized-comp.png) **Fig. 3: Proposed method - transformation result**
...
![Fig. 4: Mean / std. execution time of methods over 10 runs](readme-imgs/exec-times-comparison.png) **Fig. 4: Mean / std. execution time of methods over 10 runs**
